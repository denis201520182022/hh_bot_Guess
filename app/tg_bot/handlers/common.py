...
async def help_command(message: Message):
    ...
    content = Text(
        Bold("🆘 Справка по работе с ботом"), "\n\n",
        "Этот бот предназначен для управления и контроля ИИ-агента, работающего в вашем личном кабинете. ",
        "Здесь вы можете отслеживать эффективность системы и управлять финансовыми параметрами.\n\n",
        
        Bold("📈 Аналитика и статистика:"), "\n",
        "• ", Italic("За 7 дней:"), " краткий текстовый обзор последних событий.\n",
        "• ", Italic("Полный отчет:"), " выгрузка детальной статистики в формате Excel за любой выбранный период.\n\n",
        
        Bold("💰 Финансы и лимиты:"), "\n",
        "• В разделе ", Bold("«Баланс и Тариф»"), " можно проверить текущий остаток средств в системе и ознакомиться с актуальными тарифами на работу ИИ-агента.\n\n",
        
        "💡 ", Italic("При возникновении любых вопросов или некорректном отображении интерфейса, используйте команду"), " /start ", Italic("для перезагрузки меню.")
    )
